...
p
 ...
 # ggsave(filename=paste0("figures/GSEA_EIF2A_proteomics_", genesets[db], "_",vs[compare], ".pdf"), width=20, height=0.7* nrow(df), units="cm")
  ...
  p <- cowplot::plot_grid(plot_list[[1]], plot_list[[2]], plot_list[[3]], plot_list[[4]],
                     ...
                     rel_heights = heights)
  p
  ggsave(filename=paste0("figures/GSEA_EIF2A_proteomics_", genesets[db], "_FDR", fdr_cutoff, ".pdf"), width=20, height=0.7*sum(heights), units="cm")
  
  p
  ggsave(filename=paste0("figures/GSEA_EIF2A_proteomics_", genesets[db], "_FDR", fdr_cutoff, ".svg"), width=20, height=0.7*sum(heights), units="cm")
