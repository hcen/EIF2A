...
getwd()
setwd("C:\\Users\\LY/Documents/EP-RNAseq2020_HC/")
...
norm.data = assay(vsd)
head(norm.data)
write.table(norm.data, sep="\t",file="data/Norm_data_all_genes_noFilter.txt", 
            row.names=TRUE,col.names=NA,quote=FALSE)
...
##
##
cat("result summary", out, file="data/res_summary_3.txt", sep="\n", append=TRUE)
cat("result summary", out, file="data/res_summary_1.txt", sep="\n", append=TRUE)
cat("result summary", out, file="data/res_summary_0.txt", sep="\n", append=TRUE)
##
##
...
##
##
write.table(res.ord, sep="\t",file="data/Results_3.txt",row.names=TRUE,col.names=NA,quote=FALSE)
write.table(res.ord, sep="\t",file="data/Results_1.txt",row.names=TRUE,col.names=NA,quote=FALSE)
write.table(res.ord, sep="\t",file="data/Results_0.txt",row.names=TRUE,col.names=NA,quote=FALSE)
##
##
